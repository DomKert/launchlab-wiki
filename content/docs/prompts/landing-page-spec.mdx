...
<div className="my-4 space-y-3">
  <div>
    <PersistentCheckbox id="lp-spec-prereq-1" label="4-box.md code block copied and ready" />
  ...
  <div>
    <PersistentCheckbox id="lp-spec-prereq-2" label="One Metric picked from Prompt 14" />
