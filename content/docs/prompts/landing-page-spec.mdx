...
Two things ready to paste. Tick each as you confirm.

<div className="my-4 space-y-3">
  <div>
    <PersistentCheckbox id="lp-spec-prereq-1" label="Copy 4-box.md code block and have it ready" />
    <p className="ml-7 mt-1 text-sm text-fd-muted-foreground">From <a href="/docs/prompts/four-box" className="text-emerald-600 hover:underline dark:text-emerald-400">Prompt 2 The 4-box</a>. Copy the output code block.</p>
  </div>
  <div>
    <PersistentCheckbox id="lp-spec-prereq-2" label="Pick One Metric from Prompt 14" />
    <p className="ml-7 mt-1 text-sm text-fd-muted-foreground">From <a href="/docs/prompts/pick-your-metric" className="text-emerald-600 hover:underline dark:text-emerald-400">Prompt 14 Pick your One Metric</a>. Without the metric, this prompt picks a generic structure and your page won't bend around what you're actually trying to drive.</p>
  </div>
</div>
