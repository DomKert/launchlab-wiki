...
If this is your landing-page copy from [Prompt 4](/docs/prompts/landing-page-spec), save the cleaned output as `cleaned-copy.md` in your Claude Project knowledge (Files +, Add text content). [Prompt 17 Bolt build prompt](/docs/prompts/bolt-build) reads it from there when it synthesizes your Bolt-ready first message. No manual pasting between steps.

For other copy (broadcasts, social posts, demo pitches), just keep the cleaned output handy. Those flows don't pipe into Bolt.
